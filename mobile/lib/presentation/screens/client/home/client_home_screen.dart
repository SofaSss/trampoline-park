              ...
              body: SafeArea(
                child: RefreshIndicator(
                  onRefresh: () async {
                    ...
                    bloc.add(ClientHomeEvent.getProfilePicture());
                    bloc.add(ClientHomeEvent.getWorkoutTypeList());
                    bloc.add(ClientHomeEvent.getCoachList());
                    bloc.add(ClientHomeEvent.getVideoWarmUp());
                    bloc.add(ClientHomeEvent.getCommunicationList());
                  },
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              return GestureDetector(
                                child: BaseBigCard(
                                  imageUrl:
                                      state.workouts[index].workoutPicture,
                        ...
                        HeaderSectionWidget(
                          ...
                          description:
                              context.localization.excursionDescription,
                        ),
                        VideoPlayerWidget(
