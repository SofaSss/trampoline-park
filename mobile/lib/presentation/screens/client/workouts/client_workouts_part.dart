...
part 'client_workouts_part.freezed.dart';
part 'bloc/client_workouts_bloc.dart';
part 'bloc/client_workouts_event.dart';
part 'bloc/client_workouts_state.dart';
part 'client_workouts_screen.dart';
part 'widgets/client_rating_widget.dart';